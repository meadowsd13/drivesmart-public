...
// make the confirmation button work after choosing one of the choice (make sure the user choose one of the option)
    ...
    //make the "next" button work and move on the next questions
    ...
    //function to start the timer at the beginning of the questions
    ...
    //how does the timer work and countdown
    ...
    //check the answer if it's correct for incorrect
    ...
    //finish button after finishing all the questions in the quiz
